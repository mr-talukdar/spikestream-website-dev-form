...
const MenuOverlay = ({ menuOpen, setMenuOpen }) => {
    ...
    return (
        <General.CanvasContainer isWideScreen={isWideScreen}>
            <nav
                className={`menu fixed top-0 left-0 w-full p-10 laptop:px-56 z-10 h-screen smallphone:py-8 pt-16 laptop:py-32 bg-[#2C2C2C] transform delay-100 transition-all duration-[500ms] ${ menuOpen ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"
                ...
                <div className="h-full smallphone:pb-20 pb-28 tablet:pb-0">
                    <div className="flex flex-col h-full">
                        ...
                        <div className="basis-1/2 mac:basis-2/3 laptop:flex laptop:flex-col laptop:justify-end mac:justify-center">
                            <div className="font-medium text-accent text-lg">Contact</div>
                            <div className="grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 gap-4 tablet:gap-8">
                                <div className="">
                                    <div className="smallphone:mt-4 mt-8">For Business</div>
                                    <div className="mt-3">
                                        <a className="text-subtle" href="mailto:martin@spikestream.co" data-rel="external">martin@spikestream.co</a>
                                    </div>
                                ...
                                <div className="">
                                    ...
                                    <div className="mt-3">
                                        <a className="text-subtle" href="mailto:thinkbig@spikestream.co" data-rel="external">thinkbig@spikestream.co</a>
                                    </div>
                                </div>
                                <div className="hidden laptop:block ">
                                    <div className="mt-8">Studio Address</div>
                                    <div className="mt-4 text-subtle">Spike Stream, B-304, Swapnalok CHS LTD,
