  ...
  return (
    <div className="w-full tablet:basis-[70%] laptop:basis-[30%] laptop:mr-[1.5%]">
      <div className={`fade-up w-full`}>
        <div
          className="w-full h-[250px] tablet:h-[300px]"
        >
          <div
  ...
  return (
    <div ref={sectionRef} data-scroll-section>
      <div
        ...
        className="blogs min-h-screen w-full object-cover justify-between p-10 tablet:py-20 tablet:px-28 laptop:px-44 mac:py-24 ultrawide:py-36 flex flex-col"
      >
        <div>
          <div className="text-base laptop:text-xl fade-up">Blogs</div>
          <div className="mt-8 tablet:mt-16 laptop:mt-8 mac:mt-12 text-4xl font-light fade-up">Thoughts on how design will shape our future</div>
          ...
          <div className="mt-8 tablet:mt-16 laptop:mt-8 mac:mt-12 flex flex-row flex-wrap justify-center laptop:justify-start gap-6 tablet:gap-0">
            {
              blogData.map(item => <ListItem key={item.id} data={item} navigate={navigate} />)
            }
          </div>
        </div>
        <div>
          <div className="mt-8 flex flex-row items-center intro-text-item cursor-pointer fade-up" onClick={() => navigate('/blogs')}>
            <div className="text-sm mac:text-base font-medium">View Blogs</div>
