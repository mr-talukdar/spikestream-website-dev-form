...
function BlogPage() {
    ...
    const { data: nextBlog } = useQuery(
        API.GET_NEXT_BLOG(data ? data.blogDatas[0].id : null)
    )
                            ...
                            <div className="w-full">
                                <div className="w-screen h-screen">
                                    ...
                                    <div className="absolute top-0 left-0 mx-6 mt-9 tablet:mx-16 laptop:mx-44 laptop:my-32">
                                        ...
                                        >
                                            <img
                                                src={BLOG_IMAGES.Prev}
                                                alt={BLOG_IMAGES.Prev}
                                                className="w-[7px] h-[12px] object-contain mr-[10px] fade-up"
                                            />
                                            <div className="text-accent font-light text-[19px] fade-up">
                                                Back To Blog
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-row items-center mt-4 fade-container">
                                            <img
                                                src={BLOG_IMAGES.Time}
                                                alt={BLOG_IMAGES.Time}
                                                className="fade-up reveal-clip-anim w-[20px] h-[24px] object-contain mr-[10px] laptop:mr-[20px]"
                                            />
                                        ...
                                        <div>
                                            ...
                                            >
                                                <button className="text-white font-light text-[16px] font-medium flex flex-row items-center ">
                                                    Share this article
                                                    <img
                                                        src={BLOG_IMAGES.Share}
                                                        alt={BLOG_IMAGES.Share}
                                                        className="w-[24px] h-[24px] object-contain ml-[16px]"
                                                    />
                                                </button>
                                            </ShareOnSocial>
                                        </div>
                                    ...
                                    <div className="mt-12 tablet:mt-36 mb-44 flex flex-row items-center justify-between cursor-pointer">
                                        ...
                                        >
                                            <img
                                                src={BLOG_IMAGES.Prev}
                                                alt={BLOG_IMAGES.Prev}
                                                className="w-[7px] h-[12px] object-contain mr-[10px]"
                                            />
                                            <div className="text-accent font-light text-[16px]">
                                                Back To Blog
                                            </div>
                                        </div>
                                            ...
                                            <div
                                                className={`${
                                                    nextBlogData
                                                        ? ""
                                                        : "invisible"
                                                } text-accent font-light text-[16px]`}
                                            >
                                                Next Article
                                            </div>
                                            <img
                                                src={BLOG_IMAGES.Next}
                                                alt={BLOG_IMAGES.Next}
                                                className={`${
                                                    nextBlogData
                                                        ? ""
                                                        : "invisible"
                                                } w-[7px] h-[12px] object-contain ml-[10px]`}
                                            />
                                        </div>
                                    </div>
                                    <Footer />
