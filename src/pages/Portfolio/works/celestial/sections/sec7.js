...
import { CELESTIAL_IMAGES, VIDEOS } from "@images";
...
function KetoSec7() {
    ...
    return (
        <div ref={sectionRef} data-scroll-section>
            <div id="celestialsec6">
                <div className='w-screen min-h-screen h-screen flex items-center justify-center'>
                    <div className='w-full h-full flex items-center justify-center bg-cover bg-center py-20' style={{ backgroundImage: `url(${ CELESTIAL_IMAGES.bg })` }}>
                        <div
