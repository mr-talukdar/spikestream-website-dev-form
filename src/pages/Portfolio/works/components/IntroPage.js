            ...
            <div id={props.id}>
                <div className='w-full h-full'>
                    <div id={`${ props.id }Image`} className='bg-cover bg-center' style={props.rect ? { position: "absolute", top: props.rect.top, left: props.rect.left, width: props.rect.width, height: props.rect.height, backgroundImage: `url(${ props.cover })` } : { position: "absolute", top: 0, left: 0, width: "100%", height: "100%", backgroundImage: `url(${ props.cover })` }}>
                        <div className='pt-2 pb-12 tablet:py-44 laptop:py-12 mac:py-24 ultrawide:py-36 flex flex-col tablet:flex-row px-10 tablet:px-10 laptop:px-44 h-full w-full justify-between tablet:items-center laptop:items-start gap-y-7 tablet:gap-y-0 tablet:gap-x-10 mac:gap-x-24'>
                            ...
                            <div className="w-full ultrawide:w-2/3 max-w-[650px] h-full flex flex-col tablet:justify-center">
