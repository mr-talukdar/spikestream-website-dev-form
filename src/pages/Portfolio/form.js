...
const Form = ({ open, setOpen }) => {
      ...
      if (sendStatus) {
        return (
          <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            />
            <div className="mt-12 font-graphik font-light text-2xl tablet:text-[70px] text-center">Thank you, we will get back to you soon</div>
          </div>
        )
      }
      return (
  ...
  return (
    <nav
      className={`menu fixed flex flex-col top-0 left-0 w-full p-10 laptop:px-40 z-50 h-screen py-20 laptop:py-32 bg-black transform delay-100 transition-all duration-500 ${ open ? "opacity-100 translate-x-0" : "opacity-0 translate-x-full"
        }`}
    >
